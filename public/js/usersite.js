...
function init() {
    ...
    viewPassword.addEventListener("click", function() {
        ...
        if (pfpPass.style.webkitTextSecurity == 'disc') {
            pfpPass.style.webkitTextSecurity = 'none';
        } else {
            pfpPass.style.webkitTextSecurity = 'disc';
        }
    })
        ...
        refUsers.orderByChild('uid').equalTo(uid)
            .once("value", function(snap) {
                snap.forEach(function(data) {
                    ...
                    pfpPass.innerHTML = data.password;
                })
            })
...
// loginCheck.js to prevent conflicts
